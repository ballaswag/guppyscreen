...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 510, .adv_w = 640, .box_w = 34, .box_h = 29, .ofs_x = 3, .ofs_y = 1},
    {.bitmap_index = 1003, .adv_w = 640, .box_w = 34, .box_h = 34, .ofs_x = 3, .ofs_y = -2},
    {.bitmap_index = 1581, .adv_w = 640, .box_w = 34, .box_h = 30, .ofs_x = 3, .ofs_y = 0}
};
...
{
    {
        .range_start = 983437, .range_length = 5046, .glyph_id_start = 1,
